...
public class LaunchInterceptor {
    ...
    public boolean[] CMV() {
        // Set entire cmv vector to true for testing purposes, remove when all lic() methods are implemented
        boolean[] cmv = new boolean[15];
        for (int i = 0; i < 15; i++) {
            cmv[i] = true;
        }
        // Code to be actually used on line below commented out:
        // boolean[] cmv = {lic0(),lic1(),lic2(),lic3(),lic4(),lic5(),lic6(),lic7(),lic8(),lic9(),lic10(),lic11(),lic12(),lic13(),lic14()};
        return cmv;
    }
